...
<head>
  ...
  <link href="img/logo/caleb.jpg" rel="icon">
  <title>CUL - Login</title>
...
<body class="bg-gradient-login" style="background-image: url('img/logo/caleb.jpg'); background-size:cover;">
  <!-- Login Content -->
              ...
              <div class="col-lg-12">
                ...
                <h5 align="center">STUDENT ATTENDANCE SYSTEM</h5>
                  <div class="text-center">
                    <img src="img/logo/caleb.jpg" style="width:100px;height:100px">
                    <br><br>
